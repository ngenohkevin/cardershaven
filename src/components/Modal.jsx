          ...
          <div className="bg-gray-300 bg-gradient-to-r from-blue-200 p-2 rounded">
            <div className="py-6 px-6 lg:px-8 text-left">
              <h3 className="mb-4 text-xl text-gray-900 text-center font-bold">
                After Payment a link will be sent to your email to login and
                Access full features of our forum
              </h3>
              <hr />
              <div className="flex justify-center items-center text-sky-700 italic">
                <ul className="list-disc">
                  <li>
                    The higher you pay the more services and offers you'll
                    access
                  </li>
                  <li>30% bonus on $1000+ deposit</li>
                  <li>Access to CC checkers for Free! on $200+ deposit</li>
                  <li>
                    Your balance will be added to your account after 3
                    confirmations
                  </li>
              ...
              >
                <a
                  href="https://www.blockonomics.co/pay-url/c9c0ec04e8034696"
                  target="_blank"
