...
import { earningData, recentTransactions, weeklyStats} from '../data/dummy';
            ...
            <div className="flex flex-wrap lg:flex-nowrap justify-center">
                ...
                rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
                    <div className="flex justify-between items-center">
                        <div>
                            <p className="font-bold text-gray-400">Bank Logs, CCs, CashApp</p>
                            <p className="text-3xl">15,000</p>
                        </div>
                    </div>
                        <SiBitcoin className="mt-1 text-5xl text-bold text-yellow-500"/>
                </div>
                ...
                rounded-2xl md:w-780">
                    ...
                    <div className="mt-10 flex gap-10 flex-wrap justify-center">
                        <div className="border-r-1 border-color m-4 pr-10">
                            ...
                            {/*    />*/}
                            {/*</div>*/}
                            <div className="mt-10 text-9xl text-green-400">
                                <GiMoneyStack/>
                            </div>
                        </div>
                        <div>
            ...
            <div className="flex gap-10 m-4 flex-wrap justify-center">
                <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl">
                    ...
                    <div className="flex justify-between items-center mt-5 border-t-1 border-color">
                        ...
                        <p className="text-gray-400 text-sm">Average of 80 transactions a day</p>
                    </div>
                </div>
